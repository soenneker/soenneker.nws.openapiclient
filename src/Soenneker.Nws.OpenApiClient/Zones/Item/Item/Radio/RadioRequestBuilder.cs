...
namespace Soenneker.Nws.OpenApiClient.Zones.Item.Item.Radio
{
    ...
    public partial class RadioRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Nws.OpenApiClient.Models.TransmitterZone200LdJsonResponseSchema"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.TransmitterZone200LdJsonResponseSchema?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.TransmitterZone200LdJsonResponseSchema> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Nws.OpenApiClient.Models.TransmitterZone200LdJsonResponseSchema>(requestInfo, global::Soenneker.Nws.OpenApiClient.Models.TransmitterZone200LdJsonResponseSchema.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns transmitter object for a given zone
        /// </summary>
