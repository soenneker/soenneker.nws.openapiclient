...
namespace Soenneker.Nws.OpenApiClient.Radio.Item
{
    ...
    public partial class WithCallSignItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Nws.OpenApiClient.Models.Transmitter200LdJsonResponseSchema"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.Transmitter200LdJsonResponseSchema?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.Transmitter200LdJsonResponseSchema> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Nws.OpenApiClient.Models.Transmitter200LdJsonResponseSchema>(requestInfo, global::Soenneker.Nws.OpenApiClient.Models.Transmitter200LdJsonResponseSchema.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a single transmitter
        /// </summary>
