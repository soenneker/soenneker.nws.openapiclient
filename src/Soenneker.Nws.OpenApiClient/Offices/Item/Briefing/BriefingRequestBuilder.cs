...
#nullable enable
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.OfficeBriefingBody?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Nws.OpenApiClient.Models.OfficeBriefingBody> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Nws.OpenApiClient.Models.OfficeBriefingBody>(requestInfo, global::Soenneker.Nws.OpenApiClient.Models.OfficeBriefingBody.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns active briefing for an NWS office
        /// </summary>
